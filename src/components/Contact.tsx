        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.1422937950147!2d-73.98731968482413!3d40.75889497932681!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25855c6480299%3A0x55194ec5a1ae072e!2sTimes%20Square!5e0!3m2!1sen!2sus!4v1635959893845!5m2!1sen!2sus"
                width="100%"
                height="300"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <motion.div
              ...
              className="mt-6 p-6 card-gradient rounded-xl"
            >
              <h4 className="font-semibold text-foreground mb-3">
                Visit Our Campus
              </h4>
              <p className="text-muted-foreground text-sm mb-4">
                Come and visit our state-of-the-art facility equipped with modern classrooms, 
                laboratory, and library resources to enhance your learning experience.
              </p>
