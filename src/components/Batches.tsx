...
const Batches = ({ onRegisterClick }: BatchesProps) => {
  ...
  return (
    // scroll-mt-56 ensures this section is never hidden behind the fixed navbar
    <section id="batches" className="scroll-mt-56 pt-44 py-20 bg-secondary/50" ref={ref}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {batches.map((batch, index) => (
            <motion.div
              ...
              className="card-gradient z-10 rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 relative overflow-hidden group h-full max-w-xl w-full mx-auto"
            >
