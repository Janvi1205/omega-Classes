      ...
      <section className="pt-20 pb-12 hero-gradient">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          duration: 0.8
            ...
            <Link to="/study-material" className="inline-flex items-center gap-2 text-primary-foreground/80 hover:text-primary-foreground mb-6 transition-colors">
              <ArrowLeft size={20} />
      ...
      <section className="py-20" ref={ref}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentChapters.map((chapter, index) => <motion.div key={chapter.title} initial={{
            opacity: 0,
            y: 50
          }} animate={isInView ? {
            opacity: 1,
            ...
            y: -2
                ...
                scale: 0.95
              }} className="w-full bg-primary text-primary-foreground py-2.5 px-4 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-primary/90 transition-colors" onClick={() => {
                ...
                scale: 0.95
              }} className="w-full bg-secondary text-secondary-foreground py-2.5 px-4 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-secondary/80 transition-colors" onClick={() => {
          ...
          {currentChapters.length === 0 && <motion.div initial={{
          opacity: 0,
          y: 30
        }} animate={isInView ? {
          opacity: 1,
